...
public class FrameTest {
    ...
    @Test
    void frame_score_is_equal_to_sum_of_knocked_down_pins_when_at_least_one_remain_standing_triangulation() {
        int pinsKnockedDownOnFirstTry = 2;
        int pinsKnockedDownOnSecondTry = 3;
        int sumOfKnockedDownPins = pinsKnockedDownOnFirstTry + pinsKnockedDownOnSecondTry;
